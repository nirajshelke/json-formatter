<template>
    <button class={computedButtonClass}
        ...
        <lightning-primitive-icon icon-name={iconName} svg-class={iconSvgClass} variant="bare"></lightning-primitive-icon>

        <template if:true={computedShowDownIcon}>
            <lightning-primitive-icon icon-name="utility:down" svg-class="slds-button__icon slds-button__icon_x-small slds-m-left_xx-small" variant="bare"></lightning-primitive-icon>
        </template>
